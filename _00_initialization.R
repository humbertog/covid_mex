...
fecha_min_val <- as.Date("2021-02-02")
fecha_max_val <- as.Date("2021-02-03")
fechas_val <- seq.Date(from=fecha_min_val, to=fecha_max_val, by = "1 day")


# Reads data and selects only the confirmed COVID19 cases
covid_def <- readRDS("datos/covid_def_incremental_2021-02-03.rds")
...
last_db <- vroom("datos_csv/202102/20210203.zip", na=c("9999-99-99"), col_types=cols(PAIS_ORIGEN=col_character(), FECHA_DEF=col_date())) 
