...
for (ii in 1:length(fechas_val)) {
  ...
  plot.with.inset <-
    ...
    draw_plot(plot_deaths_cum_inset, x = .57, y = .1, width = .4, height = .4) +
    ggsave(paste("reportes_def/", mod,"_sem/def_cum/cum_lag_sem_",maxfecha,".png", sep=""),  width = 220, height = 220 * 2/3, units = "mm")
